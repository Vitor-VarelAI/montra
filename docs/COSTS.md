...
A Montra dispara gerações pagas. Registo para vigilância (PRD §7).

## Por serviço

| Serviço | Unidade | Custo | Multiplicador |
|---|---|---|---|
| GLM-5.2 | por geração | (confirmar) | × 3 versões × nº leads → **o grosso do custo** |
...
1 lead = 1 scrape FireCrawl (1 crédito)
       + 3 gerações GLM-5.2        (custo GLM × 3)
